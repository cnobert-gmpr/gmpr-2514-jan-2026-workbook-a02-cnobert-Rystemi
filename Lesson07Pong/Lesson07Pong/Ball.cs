...
public class Ball
{
    ...
    internal void Update(GameTime gameTime)
    {
        ...
        if(_position.X <= _playAreaBoundingBox.Left - 100 || 
            _position.X + _dimensions.X >= _playAreaBoundingBox.Right + 100)
        {
            _position.X = _playAreaBoundingBox.Right / 2;
            _position.Y = _playAreaBoundingBox.Bottom / 2;
        }
