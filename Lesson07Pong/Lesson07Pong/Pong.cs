...
public class Pong : Game
{
    ...
    protected override void Initialize()
    {
        ...
        _paddleR = new Paddle();
        _paddleL = new Paddle();
        _paddleR.Initialize(new Vector2(690, 198), new Vector2(8, 124), Vector2.Zero, 240, PlayAreaBoundingBox);
        _paddleL.Initialize(new Vector2(54, 198), new Vector2(8, 124), Vector2.Zero, 240, PlayAreaBoundingBox);
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        // _spriteBatch.Draw(_paddleTexture, leftPaddleRectangle, Color.White);
